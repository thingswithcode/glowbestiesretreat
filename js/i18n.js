(function() {
    ...
    var translations = {
        de: {
            ...
            'exp.quote1.text': 'Von Anfang bis Ende war alles unglaublich liebevoll und professionell organisiert. Man hat in jedem Detail gemerkt, wie viel Herzblut und Liebe in dieses Retreat geflossen sind. Vielen Dank f\u00FCr dieses unvergessliche Wochenende - ich w\u00FCrde jederzeit wieder teilnehmen!',
            'exp.quote1.name': 'Paulina',
            'exp.quote2.text': 'Genau das, was ich gebraucht habe - zwei Tage raus aus dem Alltag, rein in die Berge. Was mich wirklich beeindruckt hat, war die Liebe zum Detail: von den Goodies bis zum Essen war sp\u00FCrbar, wie viel Herzblut dahintersteckt. Ich komme definitiv wieder.',
            'exp.quote2.name': 'Alice',
            'exp.quote3.text': 'Das Yoga Retreat war für mich die perfekte kleine Atempause vom Alltag. Eine entspannte, kleine Gruppe, viel Liebe zum Detail, traumhafte Natur und tolle Impulse für den Alltag. Mein Highlight waren die Meditation am Feuer und die morgendlichen Sessions - so achtsam und ruhig in den Tag zu starten, hat total gutgetan.',
            'exp.quote3.name': 'Birte',
            'exp.quote4.text': 'Innerhalb von nur zwei Tagen fühlte ich mich wie ein komplett neuer Mensch - ruhig, klar im Kopf, geerdet und wirklich wieder mit mir selbst verbunden. Dieses Retreat war nicht einfach nur entspannend. Es hat mein Leben wirklich verändert.',
            'exp.quote4.name': 'Lucy',
